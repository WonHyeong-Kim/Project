...
<body>
	...
	<script type="text/javascript">
		...
		function connect() {
			//var chatroom = "/udon/chatRoomEnter?chat_id="+'${data.chat_id}';
			//sock = new SockJS("<c:url value="/chatroom"/>");
			...
			sock.onmessage = function(evt) {
				...
				var user_id = '${sessionScope.userDto.user_id }'
				appendMessage(obj.msg_content, obj.msg_sender, user_id);
			};
		...
		function appendMessage(msg, msg_sender, user_id) {
			...
			if (msg == '') {
				...
				var t = getTimeStamp();
				var str="";
				str += "<div class='col-12 row' style = 'height : auto; margin-top : 5px;'>";
				str += "<div class='col-2' style = 'float:left; padding-right:0px; padding-left : 0px;'>";
				str += "<img src='/udon/resources/images/profile1.png' id='profileImg' class='img-fluid' style = 'width:50px; height:50px; '>";
				str += "<div style='font-size:9px; clear:both;'>&nbsp;&nbsp;"+msg_sender+"</div>";
				str += "</div><div class = 'col-10' style = 'overflow : y ; margin-top : 7px; float:right;'>";
				if(msg_sender == user_id){
					str += "<div class = 'col-12' style = ' background-color:#fae100; padding : 10px 5px; float:left; border-radius:10px;'>";
				}else{
					str += "<div class = 'col-12' style = ' background-color:#95c4de; padding : 10px 5px; float:left; border-radius:10px;'>";
				}
				str += "<span style = 'font-size : 12px;'>";
				str += msg;
				str += "</span></div><div col-12 style = 'font-size:9px; text-align:right; float:right;'>";
				str += "<span style ='float:right; font-size:9px; text-align:right;' >";
				str += t + "</span></div></div></div>";
